...
public class MainActivity3 extends AppCompatActivity implements View.OnClickListener, OnTouchListener {
    ...
    ImageButton myImageButtonViewRefResetPiano;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myImageButtonViewRefResetPiano = findViewById(R.id.imageButtonResetPiano);
        myImageButtonViewRefResetPiano.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) { //checks which button is pressed
            ...
            case R.id.imageButtonResetPiano:
            {
                ...
                Toast.makeText(MainActivity3.this, "Sequencer Reset", Toast.LENGTH_SHORT).show();
            ...
            case R.id.imageButtonStop4://if the nextPage button is pressed
            {
                if (testVariable == 1) {
                    ...
                    testVariable = 0;
                    Toast.makeText(MainActivity3.this, "Stopped State", Toast.LENGTH_SHORT).show();
                } else {
                    checkPresses = checkPresses + 1;
                    testVariable = 1;
                    Toast.makeText(MainActivity3.this, "Playback State", Toast.LENGTH_SHORT).show();
                }
